...
async function setup_arw(save, ssv_data) {
    ...
    for (const msg of msgs) {
        if (msg.data !== '') {
            debug_log('[+] \u7f51\u9875\u6f0f\u6d1e\u5229\u7528(PSFree) (\u5efa\u7acb\u4efb\u610f r/w)');
...
async function run_psfree() {
    debug_log('[+] \u7f51\u9875\u6f0f\u6d1e\u5229\u7528 (PSFree) (\u9636\u6bb5 0 - Readying)');
    await get_ready();

    debug_log('[+] \u7f51\u9875\u6f0f\u6d1e\u5229\u7528 (PSFree) (\u9636\u6bb5 1 - UAF)');
